    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-2xl w-full space-y-8">
        ...
        <div className="text-center">
          <h1 className="text-4xl font-bold text-blue-600 mb-2">RDV</h1>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          {error && (
            <div id="error-message" className="bg-red-50 border border-red-200 rounded-md p-4" role="alert" aria-live="polite">
              <div className="flex">
                ...
                <div className="ml-3">
                  <div className="text-red-800 text-sm">{getLocalizedError(error)}</div>
                </div>
              </div>
            </div>
          )}
                    ...
                    <div key={cls.id} className="border border-gray-200 rounded-lg p-4">
                      <div className="flex items-center mb-2">
                        ...
                        <label htmlFor={`class-${cls.id}`} className="ml-3 flex items-center">
                          ...
                          {cls.description && (
                            <span className="ml-2 text-xs text-gray-500">({cls.description})</span>
                          )}
                        </label>
                      </div>
